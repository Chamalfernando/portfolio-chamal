...
interface EfinancialsDetailsProps {
  project: Project;
}

const EfinancialsDetails: React.FC<EfinancialsDetailsProps> = ({ project }) => {
  return (
    <>
      {/* Hero Image */}
      <motion.div
      ...
      >
        <div className="bg-card/50 backdrop-blur-sm rounded-2xl p-8 border border-border/50">
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            Enterprise-grade financial management system for handling fixed deposit operations. 
            Features include customer management, interest calculations, automated reporting, and comprehensive audit trails.
          </p>
...
export default EfinancialsDetails;
