...
interface BiomarkDetailsProps {
  project: Project;
}

const BiomarkDetails: React.FC<BiomarkDetailsProps> = ({ project }) => {
  return (
    <>
      {/* Hero Image */}
      <motion.div
      ...
      >
        <div className="bg-card/50 backdrop-blur-sm rounded-2xl p-8 border border-border/50">
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            Cross-platform mobile application implementing biometric authentication for attendance tracking. 
            Features real-time synchronization, offline capabilities, advanced analytics, and secure data encryption.
          </p>
